# dataset settings
dataset_type = 'IRAirDataset'
data_root = '/media/ubuntu/data/IRAir/'
...
backend_args = None
train_pipeline = [
    dict(type='LoadIRAirImageFromFiles', to_float32=True, normalized_basis=normalized_basis),
...
#         type=dataset_type,
#         data_root=data_root,
#         ann_file=data_root + 'annotations/real_data.json',
#         data_prefix=dict(img='real_data/'),
#         test_mode=True,
#         pipeline=test_pipeline))
# test_evaluator = dict(
#     type='CocoMetric',
